...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/catory.css">
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/fenlei.css">
        ...
        $(function(){
            ...
            $(function () {
                ...
                $(".arrow .arrow-left").click(function () {
                    count--;
                    if(count==-1){
                        count=$(".sliders li").length-1;
                    }
                    console.log(count);
                    $(".sliders li").eq(count).fadeIn().siblings("li").fadeOut()
                })
                $(".arrow .arrow-right").click(function () {
                    count++;
                    if(count==$(".sliders li").length){
                        count=0;
                    }
                    console.log(count);
                    $(".sliders li").eq(count).fadeIn().siblings("li").fadeOut()
            ...
            $(function () {
                var count=0;
                $(".arrows .arrows-left,.arrow .arrow-left").click(function () {
                    count--;
                    if(count==-1){
                        count=$(".sliders li,.slider li").length-1;
                    }
                    console.log(count);
                    $(".sliders li,.slider li").eq(count).fadeIn().siblings("li").fadeOut()
                })
                $(".arrows .arrows-right,.arrow .arrow-right").click(function () {
                    count++;
                    if(count==$(".slider li,.sliders li").length){
                        count=0;
                    }
                    console.log(count);
                    $(".sliders li,.slider li").eq(count).fadeIn().siblings("li").fadeOut()
    ...
    <div class="center">
        ...
        <div style="margin-bottom:-20px;padding-top:20px;">
            <div style="border:1px solid silver;">
                <div style="background:#f0f0f0;">
                    <h4 style="text-align: center;float:left;width:100px;padding-top:10px;clear:both;">品牌</h4>
                    <div class="lists"  style="background:white;float:left;width:988px;padding-bottom:15px;">
                        <a href="#home" data-toggle="tab">全部</a>
                        <c:forEach var="i" items="${commodity}">
                            <a href="#${i.cid}" data-toggle="tab">${i.cname}</a>
                        </c:forEach>
                    </div>
                    <br style="clear:both;"/>
        ...
        <div style="padding:20px 0 40px 0;">
            <div style="margin-top:20px;">
                <div style="background:white;float:left;width:270px;height:430px;padding:10px;border:1px solid silver;margin-bottom:30px;">
                    <div class="sliders" style="width:250px; height:260px;">
                        <ul>
                            <li><a href="#"><img src="images/fenlei/1.jpg" alt="" width="250px" height="auto"></a></li>
                            <li><a href="#"><img src="images/fenlei/2.jpg" alt="" width="250px" height="auto"></a></li>
                            <li><a href="#"><img src="images/fenlei/3.jpg" alt="" width="250px" height="auto"></a></li>
                        </ul>
                        <!--箭头-->
                        <div class="arrows">
                ...
                <div class="tab-pane fade in active" id="home">
                    <c:forEach var="c" items="${commodity1}" >
                        <div class="shop col-md-3" style="margin-bottom:30px;">
